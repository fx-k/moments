      ...
      <div class="moments-modal-panel w-full">
        ...
        >
          <template #onlineUrl="{ item }">
            <div class="space-y-2">
              <div class="text-xs text-gray-400 leading-5">嵌入b站视频</div>
              ...
              <div class="text-xs text-gray-400 leading-5">嵌入Youtube站视频</div>
          ...
          <template #uploadVideo="{ item }">
            <div class="space-y-2">
              <div class="text-xs text-gray-400 leading-5">上传视频</div>
              <UInput type="file" accept="video/*" size="sm" icon="i-heroicons-folder" @change="handleUploadVideo"/>
              <div class="text-xs text-gray-400 leading-5">视频地址</div>
              ...
              <div v-if="filename" class="space-y-1">
                <p class="text-xs text-gray-400 leading-5">正在上传({{ current }}/{{ total }})</p>
                <p class="text-xs text-gray-400 leading-5">{{ filename }}</p>
